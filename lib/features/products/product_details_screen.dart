...
class _ProductDetailsScreenState extends ConsumerState<ProductDetailsScreen> {
  ...
  void initState() {
    ...
    if (widget.product.colors.isNotEmpty) selectedColor = widget.product.colors.first.code;
  }
    ...
    return Scaffold(
        ...
        children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Icon(Iconsax.star, color: Theme.of(context).colorScheme.secondary, size: 20),
                          const SizedBox(width: 4),
                          Text('${widget.product.rating}', style: const TextStyle(fontWeight: FontWeight.bold)),
                          const SizedBox(width: 8),
                          Text('(${widget.product.reviewsCount} reviews)', style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Colors.lightBlue)),
                        ],
                      ),
                          ...
                          if (widget.product.sizes.isNotEmpty)
                            Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('Choose Size', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                                      ...
                                      return GestureDetector(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            border: Border.all(color: isSelected ? Theme.of(context).primaryColor : Colors.grey.withValues(alpha: 0.3)),
                                          ),
                                          child: Text(
                                            size,
                                            style: TextStyle(
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Wrap(
                                    spacing: 8,
                                    children: widget.product.colors.map((productColor) {
          ...
          Positioned(
            ...
            child: CircleAvatar(
              ...
              child: IconButton(
                icon: Icon(Iconsax.arrow_left_copy, color: Theme.of(context).primaryColor),
              ...
              child: IconButton(
                ...
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(isFav ? '"${widget.product.name}" Removed from Wishlist' : '"${widget.product.name}" Added to Wishlist', style: const TextStyle(fontWeight: FontWeight.bold, fontFamily: 'MI'),),
      ...
      bottomSheet: Container(
        ...
        child: PrimaryButton(
          ...
          onPressed: () async {
            ref.read(loaderMessageProvider.notifier).updateMessage('ADDING\nITEM TO CART...');
